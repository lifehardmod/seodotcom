...
const STYLES = {
  container: "w-full flex-col flex gap-24",
  title: "text-2xl font-semibold mb-8",
  image: "w-full",
  contentContainer: "mt-8 space-y-6 gap-8 flex flex-col",
  section: "mb-6",
        ...
        <div className={STYLES.contentContainer}>
          <div className={STYLES.section}>
            ...
            <p className={STYLES.paragraph}>
              ...
              기준으로 업무를 배분하였습니다. <br /> 매주 40시간을 기준으로
              스스로 작업을 계획하고 이슈를 설정해야 했기 때문에, 자신의 역량을
              객관적으로 파악하고 업무를 효율적으로 분배하는 능력을 기를 수
              있었습니다. <br />
              이를 통해 프로젝트를 체계적으로 분할하고 관리하는 역량이
              향상되었습니다.
            </p>
          </div>
          ...
          <div className={STYLES.section}>
            ...
            <p className={STYLES.paragraph}>
              <span className={STYLES.highlight}>
                Jira를 사용하면서 가장 좋았던 점은 프로젝트를 "데이터 기반"으로
                운영할 수 있었다는 점입니다.
              </span>{" "}
              <br />
              프로젝트를 진행하다 보면 예상치 못한 문제나 일정 지연이 발생하기
              마련인데, 이때 팀 간 갈등이 생기기 쉽습니다. <br />
              그러나 Jira를 통해 진행 상황과 이슈를 명확히 관리하면서 불필요한
              오해나 갈등을 효과적으로 줄일 수 있었습니다.
            </p>
          </div>
          ...
          <div className={STYLES.section}>
            ...
            <p className={STYLES.paragraph}>
              <span className={STYLES.highlight}>
                특히 스프린트가 완료되지 못한 경우, 주간 회고를 통해 그 원인을
                분석할 수 있었습니다.
              </span>{" "}
              <br />
          ...
          <div className={STYLES.section}>
            ...
            <p className={STYLES.paragraph}>
              <span className={STYLES.highlight}>
                데이터를 기반으로 업무를 관리하다 보니, 의견 충돌의 여지가
                줄어들었습니다.
              </span>{" "}
              <br />
              주관적인 판단이 아니라 Jira에 기록된 이슈 데이터를 바탕으로 문제를
              분석하고 해결책을 도출할 수 있었기 때문입니다. <br />그 결과, 일정
              지연과 같은 상황에서도 감정적 대응 없이 객관적인 근거를 바탕으로
              소통할 수 있었고, 팀워크를 안정적으로 유지할 수 있었습니다.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className={STYLES.contentContainer}>
          <div className={STYLES.section}>
            ...
            <p className={STYLES.paragraph}>
              ...
              것이 불가능하다는 현실을 마주했습니다. <br />
              평균 10초 이상 소요되는 트랜잭션 처리 시간은 사용자 경험 측면에서
              큰 문제로 다가왔습니다.
            </p>
          </div>
          <div className={STYLES.section}>
            ...
            <p className={STYLES.paragraph}>
              ...
              안내 메시지를 추가하여, <br />
              사용자가 로딩 중에도 진행 상황을 직관적으로 이해할 수 있도록
              구성했습니다.
              <br /> 이러한 디자인적 접근을 통해 대기 시간이 길더라도 불편함을
              최소화할 수 있었습니다.
            </p>
          </div>
          <div className={STYLES.section}>
            ...
            <p className={STYLES.paragraph}>
              ...
              <br /> 직접 담당하지 않는 기술 분야라도, 프로젝트의 전체 맥락에서
              어떤 영향을 줄 수 있는지 충분히 이해해야 한다고 생각했습니다.
            </p>
          </div>
        </div>
      </section>
