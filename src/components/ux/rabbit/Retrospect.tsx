...
const STYLES = {
  ...
  paragraph: "text-gray-100 leading-relaxed space-y-4",
        ...
        <div className={STYLES.contentContainer}>
          <div className={STYLES.section}>
            ...
            <p className={STYLES.paragraph}>
              ...
              <span>
                매주 40시간을 기준으로 스스로 작업을 계획하고 이슈를 설정해야
                했기 때문에, 자신의 역량을 객관적으로 파악하고 업무를 효율적으로
                분배하는 능력을 기를 수 있었습니다.
              </span>
              <span>
          ...
          <div className={STYLES.section}>
            ...
            <p className={STYLES.paragraph}>
              <span className={STYLES.highlight}>
                Jira를 사용하면서 가장 좋았던 점은 프로젝트를 &ldquo;데이터
                기반&rdquo;으로 운영할 수 있었다는 점입니다.
              </span>
              <span>
                프로젝트를 진행하다 보면 예상치 못한 문제나 일정 지연이 발생하기
                마련인데, 이때 팀 간 갈등이 생기기 쉽습니다.
              </span>
              <span>
          ...
          <div className={STYLES.section}>
            ...
            <p className={STYLES.paragraph}>
              ...
              <span>
                주관적인 판단이 아니라 Jira에 기록된 이슈 데이터를 바탕으로
                문제를 분석하고 해결책을 도출할 수 있었기 때문입니다.
              </span>
              <span>
                그 결과, 일정 지연과 같은 상황에서도 감정적 대응 없이 객관적인
                근거를 바탕으로 소통할 수 있었고, 팀워크를 안정적으로 유지할 수
                있었습니다.
              </span>
            </p>
          </div>
          ...
          <div className={STYLES.section}>
            ...
            <p className={STYLES.paragraph}>
              ...
              <span>
                ...
                직관적으로 이해할 수 있도록 구성했습니다.
              </span>
              <span>
                이러한 디자인적 접근을 통해 대기 시간이 길더라도 불편함을
                최소화할 수 있었습니다.
              </span>
            </p>
          </div>
