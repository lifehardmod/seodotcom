          ...
          <div className="flex flex-col gap-12 flex-1">
            ...
            <ResumeCategory title="수상 및 자격 사항">
              <ResumeItem
                ...
                date="2025.08"
                content="Frontend 개발을 담당하여, 실제 창업 기업의 MVP로 웹 경매 플랫폼을 구현하였습니다. (6인팀 FE 2명)"
              ...
              <ResumeItem
                ...
                date="2024.11.29"
                content="생성형 AI를 이용한 운동 및 식단 자동 추천 서비스를 기획, 디자인, 풀스택 개발하였습니다. (2인 팀)"
                extra="수여기관 삼성전자주식회사"
              />
            </ResumeCategory>
            {/* 교내 활동 */}
          ...
          <div className="flex flex-col gap-12 flex-1">
            ...
            <ResumeCategory title="대외 활동">
              ...
              <ResumeItem
                ...
                date="2025.07"
                content="금융사회 안전망 구축을 위한 아이디어 공모전에 참가하여 서울권 예선 8개 팀에 선정되었습니다. 팀 단위 협업과 핀테크 분야에 대한 이해를 넓혔습니다."
              />
              <ResumeItem
                title="광명시 청년 위원회 2기 위원, 3기 위원장 위촉"
                date="2021.07.03 ~ 2025.07.02"
                content="현재 청년 정책 자문 활동을 하는 위원회에서 청년 위원장으로 활동하였습니다. 광명시 청년들의 실제 필요를 반영한 정책을 제안하고, 행정 담당자 및 다양한 이해관계자들과 협의하는 과정을 통해 의견을 설득력 있게 전달하고, 서로 다른 입장을 조율하는 커뮤니케이션 역량을 길렀습니다."
              />
              <ResumeItem
                title="컴투스 대학생 서포터즈"
