          ...
          <div className="flex flex-col gap-12 flex-1">
            ...
            <ResumeCategory title="대외 활동">
              <ResumeItem
                ...
                content="현재 청년정책 자문 활동을 하는 위원회에서 청년 위원장으로 활동 중입니다. 광명시 청년들의 실제 필요를 반영한 정책을 제안하고, 행정 담당자 및 다양한 이해관계자들과 협의하는 과정을 통해 의견을 설득력 있게 전달하고, 서로 다른 입장을 조율하는 커뮤니케이션 역량을 기르고 있습니다."
              />
              <ResumeItem
                title="컴투스 대학생 서포터즈"
                date="2023.07 ~ 2023.12"
                content="컴투스 서포터즈 유튜브 채널 ‘컴투뉴스’의 영상을 기획·촬영·편집하였습니다. V-log, 정보성 콘텐츠, 예능 기획 등 다양한 포맷을 다뤘습니다."
              />
              <ResumeItem
