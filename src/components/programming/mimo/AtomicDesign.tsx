  ...
  return (
    <div className="flex items-center">
      <div className="flex items-center">
        ...
        <Star key={`star-full-1`} type="svg" id="Star" fill="orange" />
        <Star key={`star-full-1`} type="svg" id="Star" fill="orange" />
        <StarHalf key={`star-half-2`} type="svg" id="Star-Half" fill="orange" />
      </div>
        ...
        <ul className="space-y-4">
          <li className="flex items-start">
            ...
            <p className={`text-lg leading-relaxed ${TEXT_STYLES.normal}`}>
              UI를{" "}
              <span className={TEXT_STYLES.highlight}>작은 단위부터 구성</span>
              하여 재사용성을 극대화하고, 컴포넌트 설계를 체계적으로 관리하기
              위해 도입했습니다.
            </p>
          </li>
          <li className="flex items-start">
            ...
            <p className={`text-lg leading-relaxed ${TEXT_STYLES.normal}`}>
              ...
              Atomic Design을 적용했습니다. (협업시 컴포넌트 구조를 이해하기
              쉽다고 생각됨)
            </p>
          </li>
        </ul>
        ...
        <ul className="space-y-4">
          ...
          <li className="flex items-start">
            ...
            <p className={`text-lg leading-relaxed ${TEXT_STYLES.normal}`}>
              ...
              통일되어 <span className={TEXT_STYLES.highlight}>UX 일관성</span>
              이 확보되었습니다.
            </p>
          </li>
          <li className="flex items-start">
            ...
            <p className={`text-lg leading-relaxed ${TEXT_STYLES.normal}`}>
              ...
              용이했고,
              <span className={TEXT_STYLES.highlight}>작은 단위 컴포넌트</span>
              를 합쳐 <span className={TEXT_STYLES.highlight}>통합 테스트</span>
      ...
      <div className="bg-black/40 p-8 rounded-xl space-y-8 w-full">
        ...
        <ul className="space-y-4">
          <li className="flex items-start">
            <span className="text-blue-400 mr-3 text-xl">•</span>
            <p className={`text-lg leading-relaxed ${TEXT_STYLES.normal}`}>
              컴포넌트를 원자 단위로 쪼개고 구조를 체계화하는 초기 설계 단계에서
              많은 시간이 소요되었습니다. 또한 Markup에도 많은 시간이
              소요되었습니다.
            </p>
          </li>
          <li className="flex items-start">
            <span className="text-blue-400 mr-3 text-xl">•</span>
            <p className={`text-lg leading-relaxed ${TEXT_STYLES.normal}`}>
              중앙에서 한 번만 수정하면 전체 반영되는 방식이 긍정적으로 사용될
              때는 간편했지만, 많은 연결 요소에서 수정이 필요할 때는
              번거로웠습니다.
            </p>
          </li>
          <li className="flex items-start">
