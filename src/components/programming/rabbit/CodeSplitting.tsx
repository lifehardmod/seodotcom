        ...
        <ul className="space-y-4">
          <li className="flex items-start">
            ...
            <p className={`text-lg leading-relaxed ${TEXT_STYLES.normal}`}>
              ...
              <span className={TEXT_STYLES.highlight}>index.js (1.7MB)</span>{" "}
              번들 파일의 크기가 크게 나타났습니다.
            </p>
          </li>
          <li className="flex items-start">
            <span className="text-blue-400 mr-3 text-xl">•</span>
        ...
        <ul className="space-y-4">
          <li className="flex items-start">
            ...
            <p className={`text-lg leading-relaxed ${TEXT_STYLES.normal}`}>
              ...
              했습니다. 또한 여러 페이지 컴포넌트들이 개별 청크로 분리되어
              전체적인 번들 구조가 최적화되었습니다.
            </p>
          </li>
          <li className="flex items-start">
            <span className="text-blue-400 mr-3 text-xl">•</span>
            <p className={`text-lg leading-relaxed ${TEXT_STYLES.normal}`}>
              ...
              하여 사용자 경험을 향상시켰습니다. 사용자는 더 빠르게 첫 화면을 볼
              수 있으며, 이후 페이지 이동 시에도 필요한 리소스만 로드하여
              효율적인 렌더링이 가능해졌습니다.
            </p>
          </li>
          <li className="flex items-start">
            ...
            <p className={`text-lg leading-relaxed ${TEXT_STYLES.normal}`}>
              ...
              하여, 새로운 페이지가 추가될 때마다 일관되고 간편하게 코드
              스플리팅을 적용할 수 있도록 설계했습니다.
            </p>
          </li>
        </ul>
      </div>
